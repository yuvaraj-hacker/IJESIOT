...
const Main = () => {
  ...
  return (
    <>
      ...
      {showScroll && (
        <button onClick={scrollToTop} className="fixed bottom-5 right-5 bg-white  text-[#242120] cursor-pointer border font-bold border-[#242120] p-3 rounded-full shadow-lg transition-opacity hover:bg-opacity-80"  >
