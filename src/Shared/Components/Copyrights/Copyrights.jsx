                    ...
                    <section className="flex flex-col md:gap-10 gap-5">
                        <section className='grid   grid-cols-1   gap-2'>
                            <div className='flex flex-col gap-2'>
                                <h2 className='text-[#242120] font-bold merry md:text-lg underline underline-offset-2'>Copyright Transfer:</h2>
                                <div className='flex   gap-3'>
                                    <i className="fi fi-rr-angle-double-small-right     "></i>

                                    <p className="text-justify  md:text-base text-sm">By signing this form, the author(s) transfer the copyright of the article to IJESIOT, effective if and when the article is accepted for publication. The copyright transfer covers the exclusive right to reproduce and distribute the article, including reprints, translations, photographic reproductions, microform, electronic form, or any other reproductions of similar nature.</p>
                            ...
                            <ol className="list-disc  pl-5  space-y-2  ">
                                ...
                                <li className="">
                                    I/We agree to indemnify the editors of IJESIOT against any claims or expenses arising from a breach of this declaration.
                                </li>
                            </ol>
                        ...
                        <section className="flex flex-col gap-4">
                            ...
                            <p className="text-justify md:text-base text-sm">
                                I/We ____________________________, the author(s) of the research paper/article entitled ______________________, hereby grant permission for the publication of the above-mentioned paper/article in IJESIOT (International Journal of Embedded Systems and IoT).
                            </p>
                            <p className="text-justify md:text-base text-sm">
