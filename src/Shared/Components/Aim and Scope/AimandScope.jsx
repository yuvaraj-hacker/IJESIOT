                    ...
                    <section className="flex flex-col md:gap-10 gap-5">
                        ...
                        <section className="flex flex-col gap-4">
                            ...
                            <div className="md:text-base text-sm">
                                <ul className="list-disc list-inside flex flex-col gap-2">
                                    <li><strong>Embedded Systems Design & Development</strong> – Microcontrollers, system-on-chip (SoC), FPGA-based solutions, low-power and real-time embedded computing.</li>
                                    <li><strong>Internet of Things (IoT) Architectures & Applications</strong> – IoT frameworks, device-to-cloud integration, smart sensing, and connected systems.</li>
                                    <li><strong>Edge & Cloud Computing for IoT</strong> – Edge intelligence, fog computing, distributed systems, and cloud-assisted IoT solutions.</li>
                                    <li><strong>Wireless Sensor Networks & Communication Protocols</strong> – Secure and efficient communication in IoT ecosystems, including LPWAN, Bluetooth, Zigbee, and 5G.</li>
                                    <li><strong>Cybersecurity & Privacy in IoT</strong> – Secure authentication, encryption, blockchain for IoT security, and data protection.</li>
                                    <li><strong>AI & Machine Learning in Embedded Systems</strong> – AI-driven edge computing, real-time predictive analytics, and intelligent automation.</li>
                                    <li><strong>Industrial IoT (IIoT) & Smart Applications</strong> – Applications in healthcare, agriculture, automotive, smart cities, and Industry 4.0.</li>
                                    <li><strong>Energy-Efficient & Sustainable IoT</strong> – Green IoT solutions, energy harvesting in embedded devices, and low-power computing.</li>
                                    <li><strong>Real-Time & Safety-Critical Systems</strong> – Embedded solutions for automotive, aerospace, healthcare, and defense industries.</li>
                                </ul>
                            </div>
                        ...
                        <section className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1  md:gap-10 gap-5'>
                            <div className='flex flex-col gap-2 p-4 bg-[#D9D9D9]   border-2 border-[#D3A66F]   rounded-xl'>
                                <h2 className='text-[#242120] font-bold merry md:text-lg underline underline-offset-2'>Innovation</h2>
                            ...
                            <div className='flex flex-col gap-2 p-4 bg-[#D9D9D9]   border-2 border-[#D3A66F]   rounded-xl'>
                                <h2 className='text-[#242120] font-bold merry md:text-lg  underline underline-offset-2'>Collaboration</h2>
                                <div className='flex   gap-3'>
                                    <i className="fi fi-rr-angle-double-small-right     "></i>
                            ...
                            <div className='flex flex-col gap-2 p-4 bg-[#D9D9D9]   border-2 border-[#D3A66F]   rounded-xl'>
                                <h2 className='text-[#242120] font-bold merry md:text-lg  underline underline-offset-2' >Research Excellence</h2>
                                <div className='flex   gap-3'>
                                    <i className="fi fi-rr-angle-double-small-right     "></i>
